...
void svg_header(void)
{
	...
	svg("<!-- This file is a bootchart SVG file. It is best rendered in a browser such as -->\n");
	svg("<!-- Chrome/Chromium, firefox. Other applications that render these files properly -->\n");
	svg("<!-- but much more slow are ImageMagick, gimp, inkscape, etc.. To display the -->\n");
	svg("<!-- files on your system, just point your browser to file:///var/log/ and click. -->\n\n");

	svg("<!-- This bootchart was generated by bootchart version %s, running with options: -->\n", BOOTCHARTVERSION);
	svg("<!-- hz=\"%d\" n=\"%d\" -->\n", hz, len);
	svg("<!-- x=\"%d\" y=\"%d\" -->\n", scale_x, scale_y);
	svg("<!-- rel=\"%d\" f=\"%d\" p=\"%d\" -->\n", relative, filter, pss);
